...
class MLTreeMaker: public ::AthHistogramAlgorithm { 
  ...
  private: 
    ...
    // Taus
    std::vector<float> m_truthTauEta;
    std::vector<float> m_truthTauPhi;
    std::vector<float> m_truthTauPt;
    std::vector<float> m_truthTauE;

    std::vector<int> m_truthTauPdgId;

    std::vector<double> m_truthTauPtVis;
    std::vector<double> m_truthTauEtaVis;
    std::vector<double> m_truthTauPhiVis;
    std::vector<double> m_truthTauMVis;

    std::vector<double> m_truthTauPtVisNeutral;
    std::vector<double> m_truthTauEtaVisNeutral;
    std::vector<double> m_truthTauPhiVisNeutral;
    std::vector<double> m_truthTauMVisNeutral;

    std::vector<double> m_truthTauPtVisCharged;
    std::vector<double> m_truthTauEtaVisCharged;
    std::vector<double> m_truthTauPhiVisCharged;
    std::vector<double> m_truthTauMVisCharged;

    std::vector<int> m_truthTauDecayMode;
    std::vector<int> m_tauDecayMode;

    std::vector<double> m_tauPt;
    std::vector<double> m_tauEta;
    std::vector<double> m_tauPhi;
    std::vector<double> m_tauE;



    std::vector<double> m_tauPtJetSeed;
    std::vector<double> m_tauPtDetectorAxis;
    std::vector<double> m_tauPtIntermediateAxis;
    std::vector<double> m_tauPtTauEnergyScale;
    std::vector<double> m_tauPtTauEtaCalib;
    std::vector<double> m_tauPtPanTauCellBasedProto;
    std::vector<double> m_tauPtPanTauCellBased;
    ...
    std::vector<double> m_tauTruthMVisCharged;
    std::vector<double> m_tauTruthPhiVisCharged;
