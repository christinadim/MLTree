...
StatusCode MLTreeMaker::initialize() {
  ...
  if (m_doEventTree) {
    ...
    m_eventTree->Branch("truthTauPdgId",      &m_truthTauPdgId);

    m_eventTree->Branch("truthTauPt",         &m_truthTauPt);
    m_eventTree->Branch("truthTauE",          &m_truthTauE);
    m_eventTree->Branch("truthTauEta",        &m_truthTauEta);
